        ...
        <div className="relative w-full h-full bg-slate-950 overflow-hidden flex items-center justify-center select-none">
          ...
          {!isPip && (
            <div className="absolute inset-0 pointer-events-none border-[12px] border-slate-950/20">
              ...
              {/* Zoom display badge */}
              <div className="absolute bottom-20 md:bottom-6 left-44 md:left-32 px-3 py-1 bg-slate-950/80 border border-slate-800 rounded-lg text-[9px] font-black text-slate-400 tracking-wider transition-all duration-300">
                LENS ZOOM: {zoom.toFixed(1)}x
              </div>

              {/* Dpad steer output display */}
              {activeDirection && (
                <div className="absolute bottom-36 md:bottom-6 right-6 md:right-40 px-3 py-1 bg-slate-950/80 border border-slate-800 rounded-lg text-[9px] font-black text-emerald-400 tracking-wider uppercase animate-pulse transition-all duration-300">
                  DRIVE: STEERING {
